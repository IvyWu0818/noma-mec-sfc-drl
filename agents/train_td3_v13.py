...
from envs.iiot_env_v13 import IIoTEnvV13, TX_POWER_W, NOISE_POWER_W, BANDWIDTH_MHZ
...
class V13MetricsCallback(BaseCallback):
    """
    V13: 同 V12 追蹤項目，sinr obs 還原為 max(|h|²)
    """
...
def main():
    env = Monitor(IIoTEnvV13(), "logs/v13_")
    ...
    print("=" * 60)
    print("V13 Training (5G NR params + V11-style channel obs)")
    print("=" * 60)
    ...
    print(f"  Obs[14]=max(|h|^2)  (V11 style, range ~0.1-2.0)")
    print(f"[Obs=21, Action=16 | Total timesteps: 1,000,000]")
    print("=" * 60)

    model.learn(total_timesteps=1_000_000, callback=callback)
    model.save("models/td3_iiot_v13_final")

    output_path = "results/td3_v13_training_metrics.json"
